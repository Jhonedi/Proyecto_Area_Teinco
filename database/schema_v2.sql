-- Base de datos para Sistema de Inventario de Taller Automotriz - Versión 2
-- Charset: UTF-8 para soporte completo de español
-- MEJORAS:
-- 1. Placa como identificador único con validación de formato
-- 2. Historial completo de quién modificó cada registro
-- 3. Mejor estructura de índices
...
-- MEJORA: Placa como identificador único con validación
...
-- MEJORA: Incluye campo para registrar quién realizó el movimiento
...
-- Tabla de historial de ajustes de inventario
-- NUEVA: Para mantener un registro completo de ajustes manuales
